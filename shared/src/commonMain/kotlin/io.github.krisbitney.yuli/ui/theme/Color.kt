...
val LightColorScheme = lightColorScheme(
    ...
    secondary = Color(0xFFDDCFC5), // slightly darker light creamy background
    onSecondary = Color(0xFF0C253B), // dark greenish-bluish text
    secondaryContainer = Color(0xFFE4B1A1), // pinkish button color
    onSecondaryContainer = Color(0xFFFFFFFF), // slightly off-white text
